(function (global, factory) {
	...
	(factory((global.ctrl = global.ctrl || {}, global.ctrl['ngx-emoji-mart'] = global.ctrl['ngx-emoji-mart'] || {}, global.ctrl['ngx-emoji-mart']['ngx-emoji'] = {}),global.ng.core,global.ng.common));
...
var EmojiService = /** @class */ (function () {
    ...
    EmojiService.prototype.uncompress = function (list) {
        var _this = this;
        this.emojis = list.map(function (data) {
            if (!data.short_names) {
                data.short_names = [];
            }
...
var EmojiComponent = /** @class */ (function () {
    ...
    EmojiComponent.prototype.ngOnChanges = function () {
        ...
        var unified = data.unified, custom = data.custom, short_names = data.short_names, imageUrl = data.imageUrl, obsoleted_by = data.obsoleted_by, native = data.native;
        this.unified = null;
        if (custom) {
            this.custom = custom;
        }
